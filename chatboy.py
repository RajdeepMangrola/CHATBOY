...
def sendemail(to,msg):
    ...
    server.ehlo()
    server.starttls()
    server.login("partylifebyraj@gmail.com","mangrola@123")
    server.sendmail("partylifebyraj@gmail.com", to, msg)
    server.close()
...
if __name__ == "__main__":
    ...
    while True:
        ...
        elif "send an email to usha" in querry:
            try:
                speak("alright say what you wanna say to raj")
                msg = takecommand()
                to = "iamrajdeep1@gmail.com"
                sendemail(to,msg)
